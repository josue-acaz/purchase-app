...
var RequestEditComponent = /** @class */ (function () {
    function RequestEditComponent(formBuilder, toolsService, service, toastr, modalService, platformDetectorService, fluent, messageService) {
    ...
    RequestEditComponent.prototype.ngOnInit = function () {
        ...
        this.subscription_change_action = this.service.change_action_emitter.subscribe(function (action) {
            if (action == 'editing')
                _this.edit();
        });
    };
    // Cria o formulário
    RequestEditComponent.prototype.createForm = function () {
    ...
    RequestEditComponent.prototype.OnSubmitRequest = function () {
    ...
    // Salva a requisição
    RequestEditComponent.prototype.save = function () {
        var _this = this;
        this.errors = [];
        ...
        this.service.save(this.data_edit).subscribe(function (response) {
            _this.processing = false;
            if (response.resultStatus == 'success') {
                _this.toastr.success('Registro salvo com sucesso!', 'OK!');
                _this.service.edit_id = JSON.parse(JSON.stringify(response.data));
                _this.list();
            }
        });
    };
    // Atualiza a requisição
    RequestEditComponent.prototype.update = function () {
        var _this = this;
        this.errors = [];
        this.processing = true;
        this.data_edit = JSON.parse(JSON.stringify(this.requestForm.value));
        this.data_edit.req_deadline = this.toolsService.format_data_br_sql(this.data_edit.req_deadline);
        this.service.update(this.service.edit_id, this.data_edit).subscribe(function (response) {
            _this.processing = false;
            if (response.resultStatus == 'success') {
                _this.toastr.success('Registro atualizado com sucesso!', 'Ok!');
                _this.service.edit_id = JSON.parse(JSON.stringify(response.data));
            }
        });
    };
    // Sai do modo de edição da requisição e retorna a listagem
    RequestEditComponent.prototype.list = function () {
        this.service.changeAction('listing');
    };
    // Entra no modo de edição da requisição
    RequestEditComponent.prototype.edit = function () {
        var _this = this;
        this.errors = [];
        this.requestForm.setValue(new _request_model__WEBPACK_IMPORTED_MODULE_8__["Request"]());
        setTimeout(function () {
            _this.platformDetectorService.isPlatformBrowser() && _this.input_focus.nativeElement.focus();
        }, 300);
        ...
        this.processing = true;
        this.service.getById(this.service.edit_id).subscribe(function (response) {
            _this.processing = false;
            if (response.resultStatus == 'success') {
                _this.data_edit = JSON.parse(JSON.stringify(response.data));
                if (_this.data_edit.req_status == 'A') {
                    _this.isReadOnly = true; // Bloquear inputs
                }
                else {
                    _this.isReadOnly = false; // Liberar inputs
                }
                console.log("Status da requisição é --> " + _this.data_edit.req_application);
                _this.data_edit.req_deadline = _this.toolsService.format_data_sql_br(_this.data_edit.req_deadline);
                _this.requestForm.setValue(_this.data_edit);
                console.log(_this.requestForm.value);
            }
            else {
                for (var i = 0; i < response.resultMessages.length; i++) {
                    _this.errors.push(response.resultMessages[i]);
                }
            }
        }, function (error) {
            _this.processing = false;
    ...
    RequestEditComponent.prototype.finish = function () {
        var _this = this;
        this.errors = [];
        this.processing = true;
        ...
        this.service.finish(obj.req_id, this.messageService.generateMsg('request', obj.req_id, 1, 2)).subscribe(function (result) {
            _this.processing = false;
            if (result.resultStatus == 'success') {
                _this.toastr.success('Registro Efetivado com sucesso!', 'OK!');
                _this.list();
            }
            else {
                for (var i = 0; i < result.resultMessages.length; i++) {
                    _this.errors.push(result.resultMessages[i]);
                }
                _this.toastr.error('Erro ao Efetivar!', 'ERRO!');
            }
        }, function (error) {
            _this.processing = false;
            _this.errors.push(error);
    ...
    // Exclui a requisição
    RequestEditComponent.prototype.delete = function () {
        var _this = this;
        this.errors = [];
        this.processing = true;
        this.modalService.close('confirm-delete-modal-request');
        var obj = JSON.parse(JSON.stringify(this.requestForm.value));
        this.service.delete(obj.req_id).subscribe(function (response) {
            _this.processing = false;
            if (response.resultStatus == 'success') {
                _this.toastr.success('Registro excluído com sucesso!', 'OK!');
                _this.list();
            }
            else {
                for (var i = 0; i < response.resultMessages.length; i++) {
                ...
                _this.toastr.error('Erro ao excluir!', 'ERRO!');
            }
        }, function (error) {
            _this.processing = false;
            _this.errors.push(error);
    ...
    RequestEditComponent.prototype.reopen = function () {
        var _this = this;
        this.errors = [];
        this.processing = true;
        this.modalService.close('confirm-reopen-modal-request');
        var obj = JSON.parse(JSON.stringify(this.requestForm.value));
        this.service.reopen(obj.req_id).subscribe(function (result) {
            _this.processing = false;
            if (result.resultStatus == 'success') {
                _this.toastr.success('Requisição Estornada com sucesso!', 'OK!');
                _this.edit();
            }
            else {
                for (var i = 0; i < result.resultMessages.length; i++) {
                ...
                _this.toastr.error('Erro ao Estornar!', 'ERRO!');
            }
        }, function (error) {
            _this.processing = false;
            _this.errors.push(error);
...
var RequestItemEditComponent = /** @class */ (function () {
    function RequestItemEditComponent(toolsService, toastr, service, formBuilder, modalService, platformDetectorService, fluent) {
        this.toolsService = toolsService;
        this.toastr = toastr;
        this.service = service;
        this.formBuilder = formBuilder;
    ...
    RequestItemEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.errors = [];
        this.createForm();
        ...
        this.states = rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"].create(function (observer) { observer.next(_this.mainForm.value.itm_pn); })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["mergeMap"])(function (token) { return _this.service.filterResults(token); }));
    };
    RequestItemEditComponent.prototype.ngOnDestroy = function () {
        this.subscription_change_action.unsubscribe();
    };
    // Cria o formulário reativo da requisição com algumas validações
    RequestItemEditComponent.prototype.createForm = function () {
    ...
    RequestItemEditComponent.prototype.list = function () {
        this.service.change_action('listing');
    };
    // Cria um novo item
    RequestItemEditComponent.prototype.save = function (next_action) {
        var _this = this;
        this.errors = [];
        this.processing = true;
        ...
        if (this.data_edit.itm_id == 0) {
            ...
            this.service.save(this.data_edit).subscribe(function (response) {
                ...
                if (response.resultStatus == 'success') {
                    ...
                    _this.toastr.error('Erro ao salvar!', 'ERRO!');
                }
            }, function (error) {
                if (typeof error.InvalidModelState === "undefined") {
                    ...
                    for (var i = 0; i < error.InvalidModelState.length; i++) {
                        _this.errors.push(error.InvalidModelState[i]);
                    }
                }
                _this.processing = false;
                _this.toastr.error('Não foi possível salvar o registro!', 'ERRO!');
            });
        }
    ...
    RequestItemEditComponent.prototype.edit = function () {
        var _this = this;
        this.errors = [];
        this.mainForm.setValue(new _request_item_model__WEBPACK_IMPORTED_MODULE_10__["RequestItem"]());
        setTimeout(function () { _this.platformDetectorService.isPlatformBrowser() && _this.input_focus.nativeElement.focus(); }, 300);
        this.processing = true;
        ...
        if (this.service.edit_id == 0) {
            ...
            this.service.getRequestDependencies(this.service.master_id).subscribe(function (response) {
                _this.processing = false;
                if (response.resultStatus == 'success') {
                    var data = JSON.parse(JSON.stringify(response.data));
                    _this.data_edit.itm_application = data.req_application;
                    _this.data_edit.itm_quantity = 1;
                    _this.data_edit.itm_deadline = _this.toolsService.format_data_sql_br(data.req_deadline);
                    _this.mainForm.setValue(_this.data_edit);
                    // Configura como default o valor da prioridade obtida da requisição
                    _this.mainForm.patchValue({
        ...
        // Se não for, então buscar os dados do item existente
            ...
            this.service.getById(this.service.edit_id).subscribe(function (response) {
                ...
                if (response.resultStatus == 'success') {
                    _this.data_edit = JSON.parse(JSON.stringify(response.data));
                    _this.data_edit.itm_deadline = _this.toolsService.format_data_sql_br(_this.data_edit.itm_deadline);
                    _this.mainForm.setValue(_this.data_edit);
                }
                else {
                    for (var i = 0; i < response.resultMessages.length; i++) {
    ...
    RequestItemEditComponent.prototype.delete = function () {
        var _this = this;
        this.errors = [];
        this.processing = true;
        this.modalService.close('confirm-delete-modal-movprod-item');
        var obj = JSON.parse(JSON.stringify(this.mainForm.value));
        this.service.delete(obj.itm_id).subscribe(function (result) {
            _this.processing = false;
            if (result.resultStatus == 'success') {
                _this.toastr.success('Registro excluido com sucesso!', 'OK!');
                _this.list();
            }
            else {
                for (var i = 0; i < result.resultMessages.length; i++) {
    ...
    RequestItemEditComponent.prototype.item_change_typeahead_loading = function (e) {
        this.item_typeahead_loading = e;
    };
    RequestItemEditComponent.prototype.item_typeahead_onselect = function (e) {
        console.log(e);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('input_focus', { static: true }),
    ...
    return RequestItemEditComponent;
}());
...
var RequestItemComponent = /** @class */ (function () {
    function RequestItemComponent(req_service, service, formBuilderSearch, toolsService) {
    ...
    RequestItemComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    RequestItemComponent.prototype.ngOnDestroy = function () {
        this.subscription_change_action.unsubscribe();
    };
    RequestItemComponent.prototype.createSearchForm = function () {
        this.searchForm = this.formBuilderSearch.group({
            text_search: this.formBuilderSearch.control('')
        });
    };
    RequestItemComponent.prototype.list = function () {
        var _this = this;
        this.processing = true;
        this.errors = [];
        this.data_list = [];
        ...
        this.service.list(this.query_param).subscribe(function (result) {
            console.log('Itens da requisição --> ' + result.data);
            _this.processing = false;
            if (result.resultStatus == 'success') {
                _this.total_records = parseInt(result.totalRecords);
                _this.total_pages = parseInt(result.totalPages);
                _this.data_list = JSON.parse(JSON.stringify(result.data));
                _this.resume = JSON.parse(JSON.stringify(result.resume));
                _this.service.action = 'listing';
            }
            else {
                for (var i = 0; i < result.resultMessages.length; i++) {
                    _this.service.action = '';
                    _this.errors.push(result.resultMessages[i]);
                }
            }
        }, function (error) {
    ...
    RequestItemComponent.prototype.edit = function (id) {
...
var RequestItemService = /** @class */ (function () {
    function RequestItemService(http) {
        this.http = http;
    ...
    RequestItemService.prototype.change_action = function (action) {
        this.action = action;
        this.change_action_emitter.emit(action);
    };
    // Faz a listagem dos itens de uma requisição
    RequestItemService.prototype.list = function (query_params) {
        return this.http.get(this.url + '?param=' + JSON.stringify(query_params));
    };
    RequestItemService.prototype.getById = function (id) {
        return this.http.get(this.url + '/' + id);
    };
    RequestItemService.prototype.save = function (requestItem) {
        console.log(requestItem);
        return this.http.post(this.url, requestItem);
    };
    RequestItemService.prototype.update = function (id, request_item) {
        return this.http.put(this.url + '/' + id, request_item);
    };
    // Exclui um determinado item da requisição
    RequestItemService.prototype.delete = function (id) {
        return this.http.delete(this.url + '/' + id);
    };
    // Fornecer o id da requisição para obeter os seguintes dados: prioridade, data limite e aplicação
    RequestItemService.prototype.getRequestDependencies = function (id) {
        return this.http.get(this.url + '/' + id + '/requestDependencies');
    };
    // Filtra os resultados de busca de um determinado item
    RequestItemService.prototype.filterResults = function (token) {
        return this.http.get(this.url + '/autocomplete?search=' + token)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (results) { return results.filter(function (res) { return res.itm_pn.toLowerCase().indexOf(token.toLowerCase()) > -1; }); }));
    };
...
var RequestComponent = /** @class */ (function () {
    function RequestComponent(service, formBuilderSearch, toolsService) {
        this.service = service;
        this.formBuilderSearch = formBuilderSearch;
        this.toolsService = toolsService;
    ...
    // Cria o formulário
    RequestComponent.prototype.createSearchForm = function () {
        this.searchForm = this.formBuilderSearch.group({
            text_search: this.formBuilderSearch.control(''),
    ...
    // Listar requisições
    RequestComponent.prototype.list = function () {
        var _this = this;
        this.advance_search = false;
        this.processing = true;
        this.erros = [];
        ...
        this.service.list(this.query_params).subscribe(function (result) {
            _this.processing = false;
            ...
            if (result.resultStatus == 'success') {
            ...
            else // Caso não, mostre os erros gerados
             {
                for (var i = 0; i < result.resultMessages.length; i++) {
                    _this.service.action = '';
                    _this.erros.push(result.resultMessages[i]);
                }
            }
        }, function (error) {
            _this.processing = false;
            _this.erros.push(error);
        });
    };
    // Adicionar requisição
    RequestComponent.prototype.edit = function (id) {
        this.advance_search = false;
        this.service.edit_id = id;
    ...
    RequestComponent.prototype.change_order = function (order) {
    ...
    RequestComponent.prototype.change_row_per_page = function () {
        var n = this.query_params.row_per_page;
        if (n < 1)
    ...
    RequestComponent.prototype.next_page = function () {
    ...
    RequestComponent.prototype.previous_page = function () {
    ...
    RequestComponent.prototype.first_page = function () {
        this.query_params.current_page = 1;
        this.list();
    };
    // Retorna a última página
    RequestComponent.prototype.last_page = function () {
...
var ROUTES = [{ path: '', component: _request_component__WEBPACK_IMPORTED_MODULE_7__["RequestComponent"] }];
...
var RequestService = /** @class */ (function () {
    ...
    RequestService.prototype.changeAction = function (action) {
        this.action = action;
        this.change_action_emitter.emit(action);
    };
    // Lista as requisições
    RequestService.prototype.list = function (query_params) {
        return this.http.get(this.url + '?param=' + JSON.stringify(query_params));
    };
    ...
    RequestService.prototype.update = function (id, request) {
        return this.http.put(this.url + '/' + id, request);
    };
    // Finaliza e envia para aprovação a requisição atual
    RequestService.prototype.finish = function (id, message) {
    ...
    RequestService.prototype.reopen = function (id) {
...
var MessageService = /** @class */ (function () {
    function MessageService(toolsService) {
        this.toolsService = toolsService;
        // Cria mensagem
        this.message = new _message_model__WEBPACK_IMPORTED_MODULE_2__["Message"]();
    }
    // Cria a mensagem
    MessageService.prototype.generateMsg = function (msg_source_type, msg_source_key, msg_from, msg_to) {
...
var ToolsService = /** @class */ (function () {
    ...
    ToolsService.prototype.calcHour = function (hour1, hour2) {
        if (hour1 == '' || hour1 == null)
            return '';
        if (hour2 == '' || hour2 == null)
            return '';
    ...
    ToolsService.prototype.convertHourToDecimal = function (hour) {
        if (hour == null) {
            return 0;
        }
        var hr = hour.split(":");
    ...
    ToolsService.prototype.zeroPad = function (num, places) {
        var zero = places - num.toString().length + 1;
        return Array(+(zero > 0 && zero)).join("0") + num;
    };
    ToolsService.prototype.convertDatePickerToBr = function (data) {
        var data_retorno = new Date(data);
        return this.format_data_sql_br(data_retorno.toJSON());
    };
    ToolsService.prototype.convertDatePickerToSql = function (data) {
        if (data == '') {
            return '';
        }
        if (data == null) {
    ...
    ToolsService.prototype.format_data_br_sql = function (data) {
        console.log(data);
        if (!data) {
            return "";
        }
    ...
    ToolsService.prototype.GetCurrentDateHour = function () {
        return (new Date(new Date().toString().split('GMT')[0] + ' UTC').toISOString().split('.')[0]);
    };
    ToolsService.prototype.getDateToDatetime = function (data) {
        if (!data)
            return '';
        var data_split = data.split("T");
        return this.format_data_sql_br(data_split[0]);
    };
    ToolsService.prototype.getHourToDatetime = function (data) {
        if (!data)
            return '';
        var data_split = data.split("T");
    ...
    ToolsService.prototype.format_data_sql_br = function (data) {
        if (!data) {
            return '';
        }
        var data_split = data.split("-");
    ...
    ToolsService.prototype.format_data_dia = function (data) {
        if (!data) {
            return "";
        }
        var data_split = data.split("-");
    ...
    ToolsService.prototype.show_message_erro = function (messages) {
        var text = "";
        var i;
    ...
    ToolsService.prototype.numberFormat = function (number, decimal, hideZero) {
    ...
    ToolsService.prototype.realFormat = function (price, blank_zero) {
        if (blank_zero === void 0) { blank_zero = false; }
        if (blank_zero) {
    ...
    ToolsService.prototype.dollarFormat = function (price, blank_zero) {
        if (blank_zero === void 0) { blank_zero = false; }
        if (blank_zero) {
            if (parseFloat(price) == 0) {
                return "";
    ...
    ToolsService.prototype.moneyBrToSql = function (numero) {
        if (numero == '')
            return '0';
    ...
    ToolsService.prototype.numberToSql = function (numero) {
        if (numero == '')
            return '0';
        var res = numero.toString().replace(",", ".");
        return res;
    };
    ToolsService.prototype.sqlToNumber = function (numero) {
        if (numero == '')
            return '0';
        var res = numero.toString().replace(".", ",");
        return res;
...
var Fluent = /** @class */ (function () {
    ...
    Fluent.prototype.isValidDate = function (date) {
        var notValid = false;
        var ardt = new Array;
